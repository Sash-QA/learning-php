...
$x = 5;
echo $y = $x++;         // $y получит 5, а $x станет 6
echo '<br>';

$x = 5;
echo $y = ++$x;         // $x сначала увеличится до 6, затем $y получит 6
echo '<br>';
...
// Оператор == вернет true, если в массивах одинаковые пары ключ-значение, даже если у них разный порядок и типы
var_dump($s == $t);
