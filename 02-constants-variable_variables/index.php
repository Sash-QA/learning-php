...
// Константы define определяются в момент запуска программы после компиляции
// Константы const определяются во время компиляции, то есть во время преобразования кода в машинный
